  ...
  render();
      ...
      function init(){
        ...
        function transform_torus_home(){       
          controls.tabularSegments = 6;
          controls.p=7;
          controls.q=2;
          controls.redraw();
        }

        function transform_torus_work(){
          controls.tabularSegments = 6;
          controls.p=6;
          controls.q=15;
          controls.redraw();
        ...
        function transform_torus_contact(){
          controls.tabularSegments = 8;
          controls.p=2;
          controls.q=3;
          controls.redraw();
        }

        function transform_torus_services(){
          controls.tabularSegments = 5;
          controls.p=7;
          controls.q=6;
          controls.redraw();
        }
        function transform_torus_about(){
          controls.tabularSegments = 5;
          controls.p=9;
          controls.q=6;
          controls.redraw();
